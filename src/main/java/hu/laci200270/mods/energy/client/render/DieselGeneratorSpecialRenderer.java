...
public class DieselGeneratorSpecialRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y,
		...
		// new ResourceLocation("energymod","engine"), 20);
		// net.minecraftforge.client.model.b3d.B3DLoader.instance.loadModel(new
		// ResourceLocation("energymod:assets/models/enginbe.b3d")).bake(null,
		// null, null).
		new ModelDieselGenerator((TileDieselGenerator) tileEntity).render(
				(Entity) null, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
		GL11.glPopMatrix();
		GL11.glPopMatrix();
